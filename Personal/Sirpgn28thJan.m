...
global dim;
iter=0;
data = xlsread('J:\Universita di Bologna\sv sir files 28 jan\trainingskipjumpHMMsetsepoxyvoidfile15phiqmax5deg.xlsx');
TN = 30;
dim =2 ;
kluster = 18;
...
weight(17,:) = data(28,:);
weight(18,:) = data(30,:);
weight_old = zeros(size(weight)); % create a zero matrix of same dimensions of weight
